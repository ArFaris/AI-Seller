...
import { type ButtonPaginationProps } from '../ButtonLeft'

const ButtonRight: React.FC<ButtonPaginationProps> = ({
    width = 12,
    height = 12,
    disabled = false,
    color='black',
